        ...
        <div class="col-xl">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="/kegiatan/kelola/{{ $kegiatan->id_kegiatan}}/planning/update" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="latar_belakang_kegiatan" class="form-control" id="latarBelakangKegiatan" rows="3"> {{$planning->latar_belakang_kegiatan}} </textarea>
                                </div>
                                
                                <div class="form-group">
                                    <label for="deskripsiKegiatan">Deskripsi Kegiatan</label>
                                    <textarea name="deskripsi_kegiatan" class="form-control" id="deskripsiKegiatan" rows="3" placeholder="Masukkan deskripsi kegiatan"> {{$planning->deskripsi_kegiatan}}</textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="tujuanKegiatan">Tujuan Kegiatan</label>
                                    <input name="tujuan_kegiatan" type="text" class="form-control" id="tujuanKegiatan" value="{{$planning->tujuan_kegiatan}}"></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="sasaranKegiatan">Sasaran Kegiatan</label>
                                    <input name="sasaran_kegiatan" type="text" class="form-control" id="sasaranKegiatan" rows="" value="{{$planning->sasaran_kegiatan}}">
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="tempat_kegiatan" type="text" class="form-control" id="tempatKegiatan" value="{{$planning->tempat_kegiatan}}">
                                </div> 
                            </div>
                        </div>
